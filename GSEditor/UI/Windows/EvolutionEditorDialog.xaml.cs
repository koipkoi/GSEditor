...
public partial class EvolutionEditorDialog : Window
{
  ...
  private Evolution? _result = null;
  public Evolution? Result => _result;
  ...
  public EvolutionEditorDialog(Evolution? currentItem)
  {
    ...
    for (var i = 0; i < 251; i++)
    {
      var e = _pokegold.Data.Strings.PokemonNames[i].ToString();
    ...
    {
      var name = e.ToString();
      ItemItemComboBox.Items.Add(name);
      ExchangeItemComboBox.Items.Add(name);
    }
