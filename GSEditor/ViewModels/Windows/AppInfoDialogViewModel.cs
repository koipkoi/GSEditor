...
public sealed class AppInfoDialogViewModel
{
  public BindingProperty<string> AppVersion { get; } = new($"버전 : {Platforms.AppVersion}");
  public BindingProperty<string> VersionLog { get; } = new("" +
    "### v1.2.4\n" +
