...
public sealed class StringsConverter : IPokegoldConverter
{
  public void Read(PokegoldData data)
  {
    ...
    for (var i = 0; i < 256; i++)
    {
      ...
      data.Strings.ItemNames.Add(new(bytes));
    }
    ...
    for (var i = 0; i < 67; i++)
    {
      ...
      data.Strings.TrainerClassNames.Add(new(bytes));
    }
    ...
    for (var i = 0; i < 256; i++)
    {
      ...
      data.Strings.PokemonNames.Add(new(bytes));
    }
    ...
    for (var i = 0; i < 251; i++)
    {
      ...
      data.Strings.MoveNames.Add(new(bytes));
    }
    ...
    for (var i = 0; i < 256; i++)
    {
      ...
      data.Strings.ItemDescriptions.Add(new(bytes));
    }
    ...
    for (var i = 0; i < 256; i++)
    {
      ...
      var bytes = data.GetBytes(address, b => b == 0x50);
      data.Strings.MoveDescriptions.Add(new(bytes));
    }
    ...
    for (var i = 0; i < 28; i++)
    {
      ...
      var bytes = data.GetBytes(address, b => b == 0x50);
      data.Strings.MoveTypeNames.Add(new(bytes));
    }
  }
...
#pragma warning disable IDE0230
  public void Write(PokegoldData data)
  {
    ...
    for (var i = 0; i < 256; i++)
    {
      var bytes = data.Strings.ItemNames[i].ToBytes();
    ...
    for (var i = 0; i < 67; i++)
    {
      var bytes = data.Strings.TrainerClassNames[i].ToBytes();
      data.SetBytes(address, bytes);
      address += bytes.Length;
      data.SetBytes(address++, 0x50);
    }
    ...
    for (var i = 0; i < 256; i++)
    {
      var bytes = data.Strings.PokemonNames[i].ToBytes();
      data.SetBytes(address, bytes);
      address += bytes.Length;
    ...
    for (var i = 0; i < 251; i++)
    {
      var bytes = data.Strings.MoveNames[i].ToBytes();
      data.SetBytes(address, bytes);
      address += bytes.Length;
      data.SetBytes(address++, 0x50);
    }
